...
const Footer = () => {
  return (
    <footer className="pattern bg-black relative p-40 text-center mt-20">
      <p className="text-2xl text-gray-500">
        &copy; {new Date().getFullYear()} PoPoetry. All rights reserved.
      </p>
      <p className="text-white text-2xl font-extrabold">A poem begins as a lump in the throat, a sense of wrong, a homesickness, a lovesickness.”</p>
