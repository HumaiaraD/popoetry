...
// Query: *[_type == "post" && defined(slug.current) && author._ref == $id]   | order(_createdAt desc) {    _id,    title,    slug,    _createdAt,    author -> {      _id,      name,      slug,      image,      bio    },    views,    mainImage,    categories[] -> {      _id,      title,      slug    },    body  }
